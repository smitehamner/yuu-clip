...
#   UI: static/people/speakers.js (Speakers card in the recording detail view)
#   Siblings: transcribe/diarization_client.py · scoring/llm.py (infer_speaker_names) · tests/integration/test_speakers.py, tests/ui/test_ui_speakers.py, tests/js/people/speakers.test.js
