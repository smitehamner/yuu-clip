...
# setup.html loads the committed setup.bundle.js, which already has the generated catalog
# (option lists + copy) and the shared modules inlined by esbuild - nothing to inject.
