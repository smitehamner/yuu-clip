...
- **Header** - global action buttons and live job status (step pills + cancel button). The primary actions you use most - **Analyze** and **Export** - are gold; other buttons are the cyan accent.
